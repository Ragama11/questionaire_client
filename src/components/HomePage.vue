        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a
              ...
              aria-haspopup="true"
              aria-expanded="false"
              >Draude Oba <span class="caret"></span
            ></a>
                ...
                <table class="table table-stripped">
                  <tbody>
                    <tr>
                      ...
                      <td><b>Mozilla</b></td>
                      <td>
                        <b>In celebration of women and girls everywhere</b>
                      </td>
                      <td></td>
                      <td>Mar 10</td>
                    </tr>
                    <tr>
                      ...
                      <td>Dan Glenn</td>
                      <td>
                        [ptcuser-announcements] - PTC/USER Expert Speaker Series
                        Webinar March 9, 2017 11AM (EST)
                      </td>
                    ...
                    <tr>
                      ...
                      <td>Jetpack</td>
                      <td>
                        Announcing some highly requested improvements and our
